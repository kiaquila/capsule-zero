...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| US1 / FR-003         | `grep -nE '^## (Goal                                                                                                                                               | Scope           | Negative Scenarios) ' .specify/templates/spec-template.md`returns three lines (Goal, Scope, Negative Scenarios — each suffixed with the`_(mandatory)_` marker). |
...
| US3 / FR-005         | `grep -nE '^(## Process Memory                                                                                                                                     | ### (Dead Ends  | Decisions                                                                                                                                                       | Known Issues))(                                                                                                                             | $)' .specify/templates/tasks-template.md`returns four lines covering`## Process Memory` and its three subsections. |
...
| SC-002               | `git grep -L '## Negative Scenarios' .specify/specs/0\*/spec.md                                                                                                    | grep -vE '/(001 | 002                                                                                                                                                             | 003)-'` returns empty after merge (grandfathered specs 001/002/003 are excluded from the check; every post-SENAR spec carries the section). |
