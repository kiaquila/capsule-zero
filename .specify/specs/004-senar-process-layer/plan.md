...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| US1 / FR-003         | `grep -nE "^## (Goal\|Scope\|Negative Scenarios)" .specify/templates/spec-template.md` returns three lines (Goal, Scope, Negative Scenarios — each suffixed with the `*(mandatory)*` marker).                               |
...
| US3 / FR-005         | `grep -n "^## Process Memory" .specify/templates/tasks-template.md` returns the new section; subsections `### Dead Ends`, `### Decisions`, `### Known Issues` are present (verified at lines 263/269/275 on the merge SHA). |
