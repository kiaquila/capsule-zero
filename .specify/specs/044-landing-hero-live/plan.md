...
(passed). Финальная повторная проверка после Codex P2: production build — success (33 страницы),
hero-suite — 8/8, полный landing-suite — 32/32. Прогоны сьюта дефолтными 5 локальными воркерами флейкают по dev-only механике
