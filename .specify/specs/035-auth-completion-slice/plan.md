...
| 5 | Provider-agnostic e2e: profile password change succeeds and rejects a wrong current password | Playwright `specs/auth/profile-change-password.spec.ts` green in the required `test` check |
