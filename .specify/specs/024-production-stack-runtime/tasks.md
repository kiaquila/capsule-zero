...
- **2026-06-28 keep `/app`, defer rename to `/web` to Phase 6.** Phase 1 builds `web` from `app/Dockerfile` to avoid a rename diff that would obscure the actual compose change being reviewed. Superseded 2026-06-30 by PR #57: `/app` stays canonical and `/web` is not reintroduced.
