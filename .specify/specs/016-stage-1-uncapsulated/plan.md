...
| FR-014 | Codex review P2 follow-up changed `.uncapsulated-capsule-modal` from a near-opaque dark gradient to a transparent glass surface with `rgba(18,18,18,.54)` and `blur(44px)`, matching the approved glass modal constraint. |
