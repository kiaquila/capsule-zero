...
| AC-011 | Initial red commit `fc374201b2d70c420ae02c36af2fb2d115af6dd0`: `npm --prefix tests/e2e run test -- specs/landing/legal-monetization-hold.spec.ts --project=chromium` fails because hold copy is absent/retired claims render; initial green implementation passes. Follow-up red commit `d04fd42acc8723eff692a0aac0c20c2b9524f346`: the same test fails because Privacy falsely denies the stored dormant balance; the follow-up implementation passes after distinguishing it from inactive billing/invoice/payment-provider and transaction-ledger collection. Full e2e lint/typecheck and app lint/typecheck/build also pass. |
