...
Implement the authenticated Stage 1 Profile screen from the approved prototype, including full profile/settings surface, local mock interactivity, EN/RU language controls, and local review readiness without creating a PR.
