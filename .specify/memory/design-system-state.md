...
semantic `--color-error:#FF5449` (signal red — Q4 2026-07-16, §9.11; yellow retired; on-scrim text step `--color-error-text:#FF7A70`) + gold accent `--color-gold-500/450` + `--btn-cta-*` + `--color-fav`; `--glass-*` surfaces; text-on-glass
