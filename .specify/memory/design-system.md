...
| Outfit Productivity Ratio | Wearable outfits ÷ (core + accessory items); structural layers use separate Layering Coverage. Model: `docs_capsule_zero/project/methodology/outfit-generation.md` §3 (2026-07-21). |
