...
- Persist optional `country` and `city` on `profiles`; the sign-up form no longer collects them (spec 047) — they are edited on the profile screen and never block registration.
