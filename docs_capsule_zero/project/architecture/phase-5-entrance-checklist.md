...
| Storage                         | Hetzner Object Storage buckets + CORS                                                 | Buckets exist; production CORS allows exactly `https://capsulezero.app`; signed PUT/HEAD/GET/delete round-trip verified against the chosen region; no wildcard origin                                                    |
