...
| DI-003 | Auth                      | Ory Kratos email/password in v0.1; Google OAuth and Apple Sign-In in Stage 2                                                                   | 5/5 approve             | Self-hosted, headless, integrates with Traefik forward-auth and Resend SMTP.                                                            |
...
| DI-007 | API shape                 | Go HTTP API behind Traefik; OpenAPI is the contract source for web and mobile; React Native and Next.js both consume generated clients         | 5/5 approve             | One contract source, two clients. No Server Actions doing privileged DB work.                                                            |
